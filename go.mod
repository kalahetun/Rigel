...
require (
	...
	golang.org/x/crypto v0.17.0 // indirect; 间接依赖
	golang.org/x/net v0.19.0 // indirect; 间接依赖
	golang.org/x/sys v0.15.0 // indirect; 间接依赖
	golang.org/x/text v0.14.0 // indirect; 间接依赖
	google.golang.org/protobuf v1.32.0 // indirect; 间接依赖
)
